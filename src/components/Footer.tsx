export function Footer() {
  return (
    <footer id="contact" className="bg-slate-900 pt-20 pb-8 text-slate-300 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          <div className="lg:col-span-2">
            <img src="/logosinergi.svg" alt="Sinergi Logo" className="h-12 w-auto mb-6 brightness-0 invert" />
            <h3 className="text-xl font-semibold text-white mb-4">PT Sinergi Mandiricipta Indonesia</h3>
            <p className="text-slate-400 mb-6 max-w-sm leading-relaxed">
              Delivering premium business solutions through top-tier venue rentals and cutting-edge custom software development.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                <svg className="w-6 h-6 text-blue-500 shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" /><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" /></svg>
                <span>Jl Puri Anjasmoro Blok E1, No.21, Semarang - Jawa Tengah 50144</span>
              </li>
              <li className="flex items-center gap-3">
                <svg className="w-6 h-6 text-blue-500 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" /></svg>
                <a href="mailto:sinergi@sekolahmusik.co.id" className="hover:text-white transition-colors">sinergi@sekolahmusik.co.id</a>
              </li>
              <li className="flex items-center gap-3">
        ...
        <div className="pt-8 border-t border-slate-800 text-center text-sm text-slate-500">
          <p>sekolahmusik.co.id © {new Date().getFullYear()} All rights reserved. PT Sinergi Mandiricipta Indonesia.</p>
        </div>
      </div>
    </footer>
  );
